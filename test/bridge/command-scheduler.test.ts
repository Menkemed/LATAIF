...
// mitgenommen.
{
  ...
  ok(ALLOWED_MUTATIONS.length === 103, `GATE hundertdrei (R6C: +7 Stammdaten, +4 Inventur; R6D: +28; R6E: +8; R6F: +14; R7A: +1 production.complete), nicht mehr (${ALLOWED_MUTATIONS.length})`);
