...
// Es sind sechs Lesevorgänge plus die Probe.
{
  ...
  ok(resolved.length === 108, `ALLOWLIST einhundertacht Namen insgesamt (${resolved.length})`);
  ...
  ok(reads.length === 66 && storeReads.length === 48,
