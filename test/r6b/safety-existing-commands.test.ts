...
// ══ §8 — Registry und Matrix ══════════════════════════════════════════════════
{
  ...
  ok(ALLOWED_MUTATIONS.length === 103 && ALLOWED_MUTATIONS[40] === 'invoices.cancel' && ALLOWED_MUTATIONS.at(-2) === 'documents.set_ocr' && ALLOWED_MUTATIONS.at(-1) === 'production.complete',
