...
// ══ §1 — Registry 152 → 160 ══════════════════════════════════════════════════
{
  ...
  ok(vorher.length === 80 && jetzt.length === 104 && S(jetzt.filter((o) => !vorher.includes(o))) === S([...R6E_MUT, ...R6F_MUT, ...R7A_MUT, ...PREG5_MUT]) && vorher.every((o) => jetzt.includes(o)),
  ...
  ok(rVor.length === 152 && rJetzt.length === 177 && S(rJetzt.filter((o) => !rVor.includes(o))) === S([...R6E_MUT, ...R6F_MUT, ...R7A_MUT, 'products.duplicates.get', ...PREG5_MUT]),
