...
async fn a_name_that_is_not_allow_listed_never_reaches_the_renderer() {
    ...
    for forbidden in [
        ...
        "orders.delete",
        // R6F — `consignments.cancel_sale` ist seither ausdruecklich freigegeben (Rechnungsstorno ueber die
        // R6E-Grundlage statt Loeschen, eine Transaktion). `mark_returned_after_sale` war nie der Name.
