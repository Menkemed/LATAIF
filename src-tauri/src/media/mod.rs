...
pub mod media_gc;
// v0.8.44 — the ONE definition of "which media files matter". Backup, the data-root move and the
// media GC all read it, each naming which of the two sets it needs.
